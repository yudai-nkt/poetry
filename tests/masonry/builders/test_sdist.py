...
def test_make_setup():
    poetry = Factory().create_poetry(NullIO(), project("complete"))
...
def test_make_pkg_info_any_python():
    poetry = Factory().create_poetry(NullIO(), project("module1"))
...
def test_find_packages():
    ...
    poetry = Factory().create_poetry(NullIO(), project("source_package"))
...
def test_prelease():
    poetry = Factory().create_poetry(NullIO(), project("prerelease"))
...
def test_with_c_extensions():
    poetry = Factory().create_poetry(NullIO(), project("extended"))
...
def test_with_c_extensions_src_layout():
    poetry = Factory().create_poetry(NullIO(), project("src_extended"))
...
def test_with_src_module_file():
    poetry = Factory().create_poetry(NullIO(), project("source_file"))
...
def test_default_with_excluded_data(mocker):
    ...
    poetry = Factory().create_poetry(NullIO(), project("default_with_excluded_data"))
...
def test_proper_python_requires_if_two_digits_precision_version_specified():
    poetry = Factory().create_poetry(NullIO(), project("simple_version"))
...
def test_proper_python_requires_if_three_digits_precision_version_specified():
    poetry = Factory().create_poetry(NullIO(), project("single_python"))
